...
class ConversionTablePage extends StatefulWidget {
  ...
  ConversionTablePage(this.index,this.value1);
    ...
    if (currentUser != null) {
      try {
        QuerySnapshot snapshot = await ordersCollection
            .where('email', isEqualTo: currentUser.email).where('value',isEqualTo:widget.value1)
            .get();
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        SizedBox(height: 6,),
                        Text("Duration of completion:${orderData['selectedDay']}",style: TextStyle(fontWeight: FontWeight.bold),),
                        SizedBox(height: 6,),
                        Text("Type project: ${orderData['selectedOption']}",style: TextStyle(fontWeight: FontWeight.bold),),
                        SizedBox(height: 6,),
                      ],
                    ),
                  ),
