...
class Editprofilecon extends StatefulWidget {
  const Editprofilecon({Key? key}) : super(key: key);

  @override
  State<Editprofilecon> createState() => _EditprofileconState();
}

class _EditprofileconState extends State<Editprofilecon> {
  ...
  void fetchUserData() {
    ...
    if (con != null) {
      _userDataSubscription = FirebaseFirestore.instance
          ...
          .where('email', isEqualTo: con.email)
          .snapshots()
  ...
  void updatedata() async {
    ...
    try {
      ...
      if (con != null) {
        try {
          await con.updateEmail(_emailController.text.trim());
