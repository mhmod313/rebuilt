...
import 'package:rebuilt/screens/ordersdetails-con.dart';

import '../utils/utils.dart';
import 'orderdetails.dart';

class view_orders_con extends StatefulWidget {
  const view_orders_con({Key? key}) : super(key: key);


  @override
  State<view_orders_con> createState() => _view_orders_conState();
}

class _view_orders_conState extends State<view_orders_con> {
              ...
              onTap: () {
                setState(() {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ConversionTablePage_con(index,'true',orderData['email'])));
                });
              },
              child: Container(
